...
func NewShortenURL(url string, urlRepo repositories.URLRepository) *ShortenURL {
  return &ShortenURL{url, urlRepo}
}

func (c *ShortenURL) ValidateParams() error {
...
func (c *ShortenURL) Call() (string, error) {
